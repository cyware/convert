...
pub struct Base32HexEncode {
    base32hex_encode: cyware_convert::Base32HexEncode,
}
...
impl Base32HexEncode {
    ...
    pub fn new() -> Base32HexEncode {
        Base32HexEncode {
            base32hex_encode: cyware_convert::Base32HexEncode::new(),
        }
    }
...
pub struct Base32HexDecode {
    base32hex_decode: cyware_convert::Base32HexDecode,
}
...
impl Base32HexDecode {
    ...
    pub fn new() -> Base32HexDecode {
        Base32HexDecode {
            base32hex_decode: cyware_convert::Base32HexDecode::new(),
        }
    }
