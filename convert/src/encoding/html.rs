...
pub struct HtmlEncode {
    html_encode: cyware_convert::HtmlEncode,
}
...
impl HtmlEncode {
    ...
    pub fn new() -> HtmlEncode {
        HtmlEncode {
            html_encode: cyware_convert::HtmlEncode::new(),
        }
    }
...
pub struct HtmlDecode {
    html_decode: cyware_convert::HtmlDecode,
}
...
impl HtmlDecode {
    ...
    pub fn new() -> HtmlDecode {
        HtmlDecode {
            html_decode: cyware_convert::HtmlDecode::new(),
        }
    }
