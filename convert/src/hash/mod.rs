use cyware_convert::{Operation, Sha2Version};
...
#[wasm_bindgen]
pub struct Md5Hash {
    md5_hash: cyware_convert::Md5Hash,
}
...
impl Md5Hash {
    ...
    pub fn new() -> Md5Hash {
        Md5Hash {
            md5_hash: cyware_convert::Md5Hash::new(),
        }
    }
...
#[wasm_bindgen]
pub struct Sha1Hash {
    sha1_hash: cyware_convert::Sha1Hash,
}
...
impl Sha1Hash {
    ...
    pub fn new() -> Sha1Hash {
        Sha1Hash {
            sha1_hash: cyware_convert::Sha1Hash::new(),
        }
    }
...
#[wasm_bindgen]
pub struct Sha2Hash {
    sha2_hash: cyware_convert::Sha2Hash,
}
...
impl Sha2Hash {
    ...
    pub fn new(params: ISha2Hash) -> Result<Sha2Hash, JsValue> {
        ...
        Ok(Sha2Hash {
            sha2_hash: cyware_convert::Sha2Hash::new(version),
        })
    }
