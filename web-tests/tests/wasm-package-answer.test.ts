...
describe("UrlEncoding", () => {
  it("Url encode string", () => {
    ...
    let actual = encoder.apply(utf8Encode.encode("cyware @éé🥖"));
  ...
  it("Url decode string", () => {
    ...
    let actual = encoder.apply(
      utf8Encode.encode("cyware @%C3%A9%C3%A9%F0%9F%A5%96")
    );
    let expected = utf8Encode.encode("cyware @éé🥖");
...
describe("Base64 encoding", () => {
  it("Base64 encode bytes", () => {
    ...
    let utf8Encode = new TextEncoder();
    let actual = encoder.apply(utf8Encode.encode("cyware"));
  ...
  it("Base64 decode bytes", () => {
    ...
    let expected = utf8Encode.encode("cyware");
